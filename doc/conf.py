...
sys.path.insert(0, os.path.abspath('../')); import empty
...
latex_documents = [('index', 'empty.tex', u'empty Documentation', u'', 'manual')]
...
man_pages = [('index', 'empty', u'empty Documentation', [u''], 1)]
